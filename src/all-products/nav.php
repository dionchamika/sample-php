            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="flex-shrink-0 collapse navbar-collapse navbar-collapse-light w-auto flex-grow-1 order-2 order-lg-1" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../t-shirts/" role="button">
                                T-SHIRTS
                            </a>
                        </li>
                        <li class="nav-item">
                            <div class="flex-shrink-0 collapse navbar-collapse navbar-collapse-light w-auto flex-grow-1 order-2 order-lg-1" id="navbarNavDropdown">
                                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"style="color: #213d98; font-weight: 600;">
                                            Products
                                        </a>
