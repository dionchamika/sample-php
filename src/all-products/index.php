...
.product-details {
  ...
  <!-- Page Title -->
  <title>ALL PRODUCS - SLT Clothing</title>
                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active"><a href="../all-producs/">Producs</a></li>
                            </ol>
                        </nav>       
                    </div>
                </div>
    ...
    <div class="container-fluid" data-aos="fade-in">
        ...
        <div class="d-flex justify-content-between items-center pt-5 pb-4 flex-column flex-lg-row">
            <div>
                ...
                ?>
                <p class="m-0 small"><span class="text-muted">Showing</span> - <?php echo $totalProducts; ?> items</p>
            </div>
...
$sql = "SELECT * FROM products ORDER BY PID DESC LIMIT $items_per_page OFFSET $offset";
$result = $conn->query($sql);
