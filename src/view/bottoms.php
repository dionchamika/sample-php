...
.product-details {
  ...
  <!-- Page Title -->
  <title>BOTTOMS - SLT Clothing</title>
                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active"><a href="../view/bottoms.php">Bottoms</a></li>
                            </ol>
                        </nav>       
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-between items-center pt-5 pb-4 flex-column flex-lg-row">
            <div>
                <nav aria-label="breadcrumb"></nav>
                               <?php
$sql = "SELECT COUNT(*) as totalBottoms FROM products WHERE category = 'bottoms'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
$totalBottoms = $row['totalBottoms'];

echo '<p class="m-0 small"><span class="text-muted">Showing</span> - ' . $totalBottoms . ' items</p>';
?>
...
// Specify the desired category for bottoms
$bottomsCategory = "bottoms";

$sql = "SELECT * FROM products WHERE category = '$bottomsCategory' ORDER BY PID DESC LIMIT $items_per_page OFFSET $offset";
$result = $conn->query($sql);
...
?>
     <div class="col-12 text-center py-3">
        <div class="alert alert-info" role="alert">
            <h4 class="alert-heading">No Bottoms available</h4>
...
<script>
    function applyFilters() {
        ...
        fetch('bottomssearch.php?search=' + filterSearch.value.trim())
