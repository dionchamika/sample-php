...
.product-details {
  ...
  <!-- Page Title -->
  <title>ARM CUTS - SLT Clothing</title>
                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active"><a href="../view/arm-cut.php">Arm Cuts</a></li>
                            </ol>
                        </nav>       
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-between items-center pt-5 pb-4 flex-column flex-lg-row">
            <div>
                <nav aria-label="breadcrumb"></nav>
                                                               <?php
$sql = "SELECT COUNT(*) as titalarmcuts FROM products WHERE category = 'armcut'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
$titalarmcuts = $row['titalarmcuts'];

echo '<p class="m-0 small"><span class="text-muted">Showing</span> - ' . $titalarmcuts . ' items</p>';
?>
            </div>
...
// Specify the desired shirtcategory (in this case, "armcut")
$armcut = "armcut";

$sql = "SELECT * FROM products WHERE category = '$armcut' ORDER BY PID DESC LIMIT $items_per_page OFFSET $offset";
$result = $conn->query($sql);
...
?>
     <div class="col-12 text-center py-3">
        <div class="alert alert-info" role="alert">
            <h4 class="alert-heading">No Arm cuts available</h4>
...
<script>
    function applyFilters() {
        ...
        fetch('armcutsearch.php?search=' + filterSearch.value.trim())
