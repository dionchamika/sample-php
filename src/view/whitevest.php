...
.product-details {
  ...
  <!-- Page Title -->
  <title>WHITE VEST - SLT Clothing</title>
</head>
<body>
     <?php include 'nav.php';?> 
                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active"><a href="../view/whitevest.php">whitevest</a></li>
                            </ol>
                        </nav>       
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-between items-center pt-5 pb-4 flex-column flex-lg-row">
            <div>
                <nav aria-label="breadcrumb"></nav>
                               <?php
$sql = "SELECT COUNT(*) as whitevest FROM products WHERE category = 'whitevest'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
$whitevest = $row['whitevest'];

echo '<p class="m-0 small"><span class="text-muted">Showing</span> - ' . $whitevest . ' items</p>';
?>
...
// Specify the desired category for whitevest
$whitevest = "whitevest";

$sql = "SELECT * FROM products WHERE category = '$whitevest' ORDER BY PID DESC LIMIT $items_per_page OFFSET $offset";
$result = $conn->query($sql);
...
?>
     <div class="col-12 text-center py-3">
        <div class="alert alert-info" role="alert">
            <h4 class="alert-heading">No white vests available</h4>
...
<script>
    function applyFilters() {
        ...
        fetch('westsearch.php?search=' + filterSearch.value.trim())
