                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active"><a href="../view/cap.php">cap</a></li>
                            </ol>
                        </nav>       
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-between items-center pt-5 pb-4 flex-column flex-lg-row">
            <div>
                <nav aria-label="breadcrumb"></nav>
                               <?php
$sql = "SELECT COUNT(*) as caps FROM products WHERE category = 'caps'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
$caps = $row['caps'];

echo '<p class="m-0 small"><span class="text-muted">Showing</span> - ' . $caps . ' items</p>';
?>
...
$sql = "SELECT * FROM products WHERE category = '$caps' ORDER BY PID DESC LIMIT $items_per_page OFFSET $offset";
$result = $conn->query($sql);
...
?>
     <div class="col-12 text-center py-3">
        <div class="alert alert-info" role="alert">
            <h4 class="alert-heading">No caps available</h4>
...
<script>
    function applyFilters() {
        ...
        fetch('capsearch.php?search=' + filterSearch.value.trim())
